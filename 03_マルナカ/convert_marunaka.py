...
import_file_name = 'marunaka_kagawa'
xlsx_file = f'./{import_file_name}.xlsx'
xlsx_file_start = f'./{import_file_name}_start.xlsx'
export_file_name = 'marunaka_kagawa_converted'  # * 出力ファイル名
# days_list = {
#     '月曜': '2/27',
#     '火曜': '2/28',
#     '水曜': '3/1',
